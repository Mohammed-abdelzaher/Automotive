      ...
      child: new SizedBox(
        ...
        child: new CustomPaint(
          painter: new BatteryIndicatorPainter(
              widget.batteryLv, widget.style, widget.showPercentSlide, widget.colorful, widget.mainColor),
          child: new Center(
            child: new Padding(
...
class BatteryIndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    else{batteryC=Colors.transparent;}
    if (style == BatteryIndicatorStyle.flat) {
      /// 绘制轮廓

//      canvas.drawRRect(
//          new RRect.fromLTRBR(90, 18, 18, 31, const Radius.circular(0)),
//          new Paint()
//            ..color = greyColor
//            ..strokeWidth = 2
//            ..style = PaintingStyle.stroke);
      canvas.drawRRect(
          new RRect.fromLTRBR(0.0, size.height * 0.05, size.width, size.height * 0.95, const Radius.circular(0)),
          new Paint()
      ...
      if (showPercentSlide) {
        ...
        /// 绘制填充
        canvas.drawRRect(
            new RRect.fromLTRBR(0, size.height * 0.05 , size.width, size.height * 0.95 ,
                const Radius.circular(0)),
            new Paint()
              ..shader = ui.Gradient.linear(Offset(-20,20),Offset(60,60),
                [
                  mainColor2,
                  mainColor1,
                ],
